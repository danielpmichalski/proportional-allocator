...
describe('update', () => {
    ...
    describe('update to lower', () => {
        test.each([
            ...
            [
                'in [0.0001, 0.9998, 0.0001] at position 0 to 0.0 => [0, 0.99985, 0.00015000000000000001]',
                [0.0001, 0.9998, 0.0001],
                0,
                0.0,
                [0, 0.99985, 0.00015000000000000001],
            ],
            [
            ...
            [
                'in [0.9995, 0.0002, 0.0002, 0.0001] at position 0 to 0.0 => [0, 0.33336666666666664, 0.33336666666666664, 0.33326666666666666]',
                [0.9995, 0.0002, 0.0002, 0.0001],
                0,
                0.0,
                [
                    0, 0.33336666666666664, 0.33336666666666664,
                    0.33326666666666666,
                ],
            ],
